...
card_donnees = dbc.Card(
    [
        ...
        dcc.Dropdown(
            id='dropdown_liste_film',
            options=[{'label': film, 'value': film} for film in creer_liste_film(df_commentaire)],
                    multi=True,
                    value=[film for film in creer_liste_film(df_commentaire)],
                    placeholder="Sélectionnez des films"
        ),
