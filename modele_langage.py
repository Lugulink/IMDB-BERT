...
class ModeleLangage:
    ...
    def __init__(self, nom: str = 'all-MiniLM-L6-v2') -> pd.DataFrame:  # 'all-MiniLM-L6-v2': max sequence length: 256 - plongement: 384
        self.nom = nom
    ...
    def __call__(self, liste_chaine: Union[str, list[str], pd.Series], barre_progression: bool=False) -> pd.DataFrame:
